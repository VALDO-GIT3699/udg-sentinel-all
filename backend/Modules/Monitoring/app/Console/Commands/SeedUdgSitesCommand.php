...
final class SeedUdgSitesCommand extends Command
{
    ...
    private function appendCriticalSystems(array &$catalog): void
    {
        $systems = [
            ...
            ['SIIE UDG', 'siie.udg.mx', 1, 2],
            ['SIIE UDG (WWW)', 'www.siie.udg.mx', 1, 2],
            ...
            ['Egresados UDG', 'egresados.udg.mx', 1, 2],
            ['Egresados UDG (WWW)', 'www.egresados.udg.mx', 1, 2],
            ['Bibliotecas UDG', 'bibliotecas.udg.mx', 1, 3],
            ['BPEJ UDG', 'bpej.udg.mx', 1, 3],
            ['BPEJ UDG (WWW)', 'www.bpej.udg.mx', 1, 3],
